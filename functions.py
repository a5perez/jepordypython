...
def user_interaction(picks): 
    
""" Determines category and level of difficulty.
...
""" Determines what user input for the game.
    ...
    rad : list
        The randomized list of possible answers. """
...
""" randomizez the list of possible answers.
...
""" Determines what user input for the game.
    ...
    points: int
        Total user points based on correct answers.  
